...
function latte_customize_register($wp_customize) {
	...
	$wp_customize->add_panel('latte_contactme_settings', array(
		'priority' => 20,
		'capability' => 'edit_theme_options',
		'title' => __('Contact Me Section', 'latte'),
		'description' => __('This section allows you to configure Contact Me section.', 'latte'),
	));
	...
	$wp_customize->add_section('latte_contactme_settings', array(
		'priority' => 5,
		'title' => __('Settings', 'latte'),
		'panel' => 'latte_contactme_settings',
	));

	$wp_customize->add_section('latte_contactme_content', array(
		'priority' => 10,
		'title' => __('Content', 'latte'),
		'panel' => 'latte_contactme_settings',
	));

	$wp_customize->add_section('latte_contactme_colors', array(
		'priority' => 15,
		'title' => __('Colors', 'latte'),
		'panel' => 'latte_contactme_settings',
	));
	...
	//////////////////////////////
	$wp_customize->add_setting('latte_contactme_display', array(
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'latte_sanitize_checkbox',
	));

	$wp_customize->add_control('latte_contactme_display', array(
		'type' => 'checkbox',
		'label' => __('Disable Contact Me Section', 'latte'),
		'section' => 'latte_contactme_settings',
		'priority' => 5,
	));

	$wp_customize->add_setting('latte_contactme_title', array(
		'default' => esc_html__('Contact Me', 'latte'),
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => 'postMessage',
	));

	$wp_customize->add_control('latte_contactme_title', array(
		'label' => __('Section Title', 'latte'),
		'section' => 'latte_contactme_settings',
		'priority' => 15,
		'settings' => 'latte_contactme_title',
	));

	$wp_customize->add_setting('latte_contactme_subtitle', array(
		'default' => esc_html__('Keep in touch.', 'latte'),
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => 'postMessage',
	));

	$wp_customize->add_control('latte_contactme_subtitle', array(
		'label' => __('Section Subtitle', 'latte'),
		'section' => 'latte_contactme_settings',
		'priority' => 20,
		'settings' => 'latte_contactme_subtitle',
	));

	$wp_customize->add_setting('latte_contactme_avatar', array(
		'default' => get_template_directory_uri() . '/assets/images/383x383.png',
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'esc_url_raw',
		'transport' => 'postMessage',
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'latte_contactme_avatar', array(
		'label' => __('Image', 'latte'),
		'section' => 'latte_contactme_content',
		'priority' => 5,
		'settings' => 'latte_contactme_avatar',
	)));

	$wp_customize->add_setting('latte_contactme_name', array(
		'default' => esc_html__('John Doe', 'latte'),
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => 'postMessage',
	...
	$wp_customize->add_control('latte_contactme_name', array(
		'label' => __('Name', 'latte'),
		'section' => 'latte_contactme_content',
		'priority' => 10,
		'settings' => 'latte_contactme_name',
	));

	$wp_customize->add_setting('latte_contactme_position', array(
		'default' => esc_html__('Web Designer', 'latte'),
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => 'postMessage',
	...
	$wp_customize->add_control('latte_contactme_position', array(
		'label' => __('Position', 'latte'),
		'section' => 'latte_contactme_content',
		'priority' => 15,
		'settings' => 'latte_contactme_position',
	));

	$wp_customize->add_setting('latte_contactme_content', array(
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'latte_sanitize_textbox',
		'transport' => 'postMessage',
	));

	$wp_customize->add_control('latte_contactme_content', array(
		'label' => __('Content', 'latte'),
		'section' => 'latte_contactme_content',
		'priority' => 20,
		'type' => 'textarea',
		'settings' => 'latte_contactme_content',
	));

	if (isset($wp_customize->selective_refresh)) {
		$wp_customize->selective_refresh->add_partial('latte_contactme_content', array(
			'selector' => '.contactme .lead',
			'settings' => 'latte_contactme_content',
			'render_callback' => function () {
				return get_theme_mod('latte_contactme_content');
			},
		));
	}

	$wp_customize->add_setting('latte_contactme_background_color', array(
		'default' => '#F5F5F5',
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport' => 'postMessage',
	...
	$wp_customize->add_control(new Latte_Customize_Alpha_Color_Control($wp_customize, 'latte_contactme_background_color', array(
		'label' => __('Background Color', 'latte'),
		'section' => 'latte_contactme_colors',
		'default' => '#F5F5F5',
		'priority' => 5,
		'settings' => 'latte_contactme_background_color',
	)));
	...
	$wp_customize->add_setting('latte_blogposts_category', array(
		'default' => 0,
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
	));

	$wp_customize->add_control(new Latte_Category_Dropdown_Control($wp_customize, 'latte_blogposts_category', array(
		'label' => __('Display Posts From:', 'latte'),
		'section' => 'latte_blogposts_content',
		'priority' => 10,
		'settings' => 'latte_blogposts_category',
	)));
