...
if (isset($latte_contactme_display) && $latte_contactme_display != 1):
	do_action('latte_contactme_before');
	get_template_part('sections/contactme');
	do_action('latte_contactme_after');
endif;
